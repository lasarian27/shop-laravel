        ...
        <div class="container">
            <div class="mapouter">
                <div class="gmap_canvas">
                    <iframe width="1110" height="390" id="gmap_canvas"
            ...
            <div class="intro">
               <p class="mb-0"> Etiam tincidunt turpis a vulputate. Etiam diam lorem, convallis as laoreet a, pretium id nisl. Morbi
                   tincidunt nisem. Aenean eu nulla massa. Ut interdum tristique est commodo pharetra.  Ut interdum tristique est commodo pharetra</p>
            </div>
